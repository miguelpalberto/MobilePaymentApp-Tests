...
WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/slot-tton_OK-f35'))

WebUI.closeBrowser()

/////
WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/span_button-inner-ady-1e2-530'))

WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/button_1-e-ready-552'))

WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/button_0000-e-ready-e97'))

WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/button_01-c-input-8b9'))

WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/ion-backdrop_md-erlay-3-00a'))

WebUI.click(findTestObject('TP41FilterTransactionsByDateRange/Page_Ionic App/ion-picker-column-internal_year-column'))

WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/input_End Date_dateInput'))

WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/svg_ionicon-ady-222-6b4'))

WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/button_2023-pen-839-c0e'))

WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/div_End DateOK'))

WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/div_End DateOK'))

WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/svg_ionicon-pen-a46-bb8'))

WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/span_button-inner-ady-44d-a49'))

WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/button_31-e-ready-c68'))

WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/button_25-e-ready-e19'))

WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/button_1955-e-ready-3aa'))

WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/button_56-c-input-2d9'))

WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/ion-backdrop_md-erlay-4-5e7'))

WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/button_button-native-tton_OK-484'))

WebUI.click(findTestObject('Object Repository/TP41FilterTransactionsByDateRange/a/slot-Confirm-359'))
