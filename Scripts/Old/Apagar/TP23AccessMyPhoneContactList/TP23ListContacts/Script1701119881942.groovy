...
WebUI.setEncryptedText(findTestObject('Object Repository/TP23AccessMyPhoneContactList/input_Password_ion-input-1'), 'tzH6RvlfSTg=')

WebUI.setEncryptedText(findTestObject('Object Repository/TP23AccessMyPhoneContactList/input_PIN_ion-input-2'), 'tzH6RvlfSTg=')

WebUI.click(findTestObject('TP23AccessMyPhoneContactList/ion-button_Create'))

WebUI.setEncryptedText(findTestObject('Object Repository/TP23AccessMyPhoneContactList/input_Pin_ion-input-3'), 'tzH6RvlfSTg=')
