...
WebUI.setEncryptedText(findTestObject('Object Repository/TP3CreateAVcardAssociateVcard/input_PIN_ion-input-2'), 'CSt51UwWECc=')
WebUI.click(findTestObject('Object Repository/TP3CreateAVcardAssociateVcard/ion-button_Create'));

WebUI.verifyElementText(findTestObject('Object Repository/TP3CreateAVcardAssociateVcard/p_Thepinfieldemptyor'), 'The pin field is empty or does not have 3 digits');
